...
CREATE TABLE `record` (
      ...
      `ctime` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '注册时间',
       `ng` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'ng',
       `yg` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'yg',
       `rg` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'rg',
       `sg` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'sg',
